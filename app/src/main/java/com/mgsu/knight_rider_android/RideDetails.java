...
public class RideDetails extends AppCompatActivity implements OnMapReadyCallback{
    ...
    private  void setupViews() {
        ...
        destinationTimeTextView = (TextView) findViewById(R.id.destinationTimeTextView);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            destinationTimeTextView.setText("");
                            ...
                            coordinates.put("destLat", response.getString("destLatitude"));
                            coordinates.put("destLong", response.getString("destLongitude"));
    ...
    private void setMapDirections(final HashMap<String, String> mapDirections) {
        ...
        JsonObjectRequest getDirectionsRequest = new JsonObjectRequest(Request.Method.GET, mapsUrl,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray legs = response.getJSONArray("routes")
                                    .getJSONObject(0).getJSONArray("legs")
                                    .getJSONObject(0).getJSONArray("steps");

                            String[] paths = new String[legs.length()];
                            for (int i = 0; i < paths.length; i++) {
                                paths[i] = String.valueOf(legs.getJSONObject(i)
